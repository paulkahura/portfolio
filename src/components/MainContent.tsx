...
export function MainContent() {
  ...
  function submitCommand(event: FormEvent) {
    ...
    if (value === "help" || value === "?") {
      setFeedback(
        "Navigation: about, projects, experience, resume, contact, writing, games. System: dir, whoami, status, date, time, home, back. Arcade: play snake, play signal, play mines, play claw.",
      );
      return;
    }
